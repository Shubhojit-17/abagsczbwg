...
class FeatureAggregator:
    ...
    def aggregate(self, user_features: pd.DataFrame,
        ...
        event_agg = event_features.groupby("user_id").agg(
            ...
            cross_dept_events=("is_cross_department", "sum") if "is_cross_department" in event_features.columns else ("is_high_sensitivity", lambda x: 0),
